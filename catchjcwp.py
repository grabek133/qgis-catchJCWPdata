...
/***************************************************************************
 CatchmentJcwp
                                 A QGIS plugin
 Downloads JCWP catchment data for a given investment
...
from .catchjcwp_dialog import CatchmentJcwpDialog
import os.path
...
class CatchmentJcwp:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'CatchmentJcwp_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Catchment JCWP data')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('CatchmentJcwp', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/catchjcwp/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Catchment JCWP data'),
            callback=self.run,
